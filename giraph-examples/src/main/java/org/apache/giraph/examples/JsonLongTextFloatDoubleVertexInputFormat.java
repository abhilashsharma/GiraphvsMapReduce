 ...
 */
public class JsonLongTextFloatDoubleVertexInputFormat extends
        TextVertexInputFormat<LongWritable, Text, FloatWritable> {

    @Override
    public TextVertexReader createVertexReader(InputSplit split,
                                               TaskAttemptContext context) {
        return new JsonLongTextFloatDoubleVertexReader();
    }
     ...
     * [1,4.3,[[2,2.1],[3,0.7]]]
     */
    class JsonLongTextFloatDoubleVertexReader extends
        ...
        protected Text getValue(JSONArray jsonVertex) throws
            ...
            return new Text(jsonVertex.getString(1));
        }
        ...
        @Override
        protected Vertex<LongWritable, Text, FloatWritable,
