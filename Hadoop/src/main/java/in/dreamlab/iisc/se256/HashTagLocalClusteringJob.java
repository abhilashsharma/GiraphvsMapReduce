 ...
 *
 */
public class HashTagLocalClusteringJob extends Configured implements Tool {
	private static final Logger LOG = Logger.getLogger(HashTagLocalClusteringJob.class);
 	
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new HashTagLocalClusteringJob(), args);
        System.exit(res);
	}
...
//		//conf.set("test","123");
		...
		conf.set("HashMapPath", inputPath);
	    ...
	    job.setJarByClass(HashTagLocalClusteringJob.class);	    
	    job.setMapperClass(HashTagLocalClusteringMapper.class);
//	    job.setCombinerClass(LongSumReducer.class);
	    job.setReducerClass(HashTagLocalClusteringReducer.class);
