...
import in.dreamlab.iisc.hashtag.TwitterTopoCounterMap.TwitterTopoCounterMapper;

import in.dreamlab.iisc.hashtag.TwitterTopoCounterReduce.TwitterTopoCounterReducer;
...
public class TwitterAnalyticsJob extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
	   ...
	   job.setCombinerClass(TwitterTopoCounterCombiner.class);
	    ...
	    //job.setPartitionerClass(TwitterTopoCounterMap.TwitterTopoCounterPartitioner.class);
